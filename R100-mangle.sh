...
sudo python ./run.py --node R100 --cmd "iptables -t mangle -A PREROUTING -i R100-eth3 -s 10.30.0.0/22 -d 10.200.0.0/24 -j TTL --ttl-inc 4 2>> /tmp/err"
sudo python ./run.py --node R100 --cmd "iptables -t mangle -A PREROUTING -i R100-eth3 -s 10.40.0.0/22 -d 10.200.0.0/24 -j TTL --ttl-inc 2 2>> /tmp/err"
...
#sudo python ./run.py --node R100 --cmd "iptables -t nat -A POSTROUTING -o R100-eth2 -s 10.30.0.0/22 -d 10.200.0.0/24 -j SNAT --to-source 9.0.110.2 2>> /tmp/err"
#sudo python ./run.py --node R100 --cmd "iptables -t nat -A POSTROUTING -o R100-eth2 -s 10.40.0.0/22 -d 10.200.0.0/24 -j SNAT --to-source 9.0.110.2 2>> /tmp/err"
